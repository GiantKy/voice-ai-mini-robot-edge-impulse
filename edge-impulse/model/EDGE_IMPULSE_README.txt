...
# Edge Impulse library for Điều khiển robot mini bằng lệnh giọng nói

This is a C++ library that lets you run the impulse for "Điều khiển robot mini bằng lệnh giọng nói" (https://studio.edgeimpulse.com/studio/1003610) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
